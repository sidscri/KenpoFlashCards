...
Name: "background"; Description: "Run server in background at login (Scheduled Task - recommended)"; Flags: checkedonce
...
Filename: "schtasks.exe"; Parameters: '/Create /F /SC ONLOGON /TN "AdvancedFlashcardsWebAppServer-Background" /TR "\"{app}\\{#MyAppExeName}\" --headless" /RL LIMITED'; Tasks: background; Flags: runhidden
