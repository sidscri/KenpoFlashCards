...
REM set "KENPO_WEB_PORT=8010"

REM Force-clear any old hardcoded path from your system env (so auto-discovery works)
set "KENPO_JSON_PATH="

REM API keys are now stored encrypted in data/api_keys.enc
REM Use the Android app Admin Settings or web AI Access page to manage keys

if "%KENPO_WEB_PORT%"=="" set "KENPO_WEB_PORT=8010"
