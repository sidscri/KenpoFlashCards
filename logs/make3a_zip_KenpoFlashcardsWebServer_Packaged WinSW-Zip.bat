...
REM   KenpoFlashcardsWebServer_Packagedv<major.minor> v<build> WinSW.zip
REM ZIP contents root:
REM   KenpoFlashcardsWebServer_Packaged WinSW \...
REM Reads:
REM   .\KenpoFlashcardsWebServer_Packaged WinSW\version.json
...
set "PROJ=KenpoFlashcardsWebServer_Packaged WinSW"
set "SRC=%BASE%\%PROJ%"
