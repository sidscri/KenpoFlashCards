...
REM   KenpoFlashcardsWebServer_Service_Tray-v<major.minor> v<build>.zip
REM ZIP contents root:
REM   KenpoFlashcardsWebServer_Service_Tray\...
REM Reads:
REM   .\KenpoFlashcardsWebServer_Service_Tray\version.json
REM Excludes (recursively, guaranteed):
REM   .venv, __pycache__, *.pyc
REM Writes log:
REM   logs\KenpoFlashcardsWebServer_Service_Tray.log
REM ============================================================
...
set "LOG=%BASE%\logs\KenpoFlashcardsWebServer_Service_Tray.log"
> "%LOG%" echo START %DATE% %TIME%
>>"%LOG%" echo BASE=%BASE%

set "PROJ=KenpoFlashcardsWebServer_Service_Tray"
set "SRC=%BASE%\%PROJ%"
