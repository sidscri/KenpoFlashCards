...
- Updates prefer **existing local data**; packaged data only seeds missing files.
- Tray restart menu includes: Restart (Auto), Restart Service (Admin), Restart App Only.
