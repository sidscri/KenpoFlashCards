...
UPDATE:
- Added Study Modes + per-mode settings.
- Added always-visible 'Got it ✓ (mark learned)' button.
- Added sort + randomize + show/hide group labels + reverse cards.
- Main group selection is now a dropdown (All is a standalone chip).
